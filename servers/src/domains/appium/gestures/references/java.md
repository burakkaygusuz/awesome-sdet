# Appium W3C Actions API & Mobile Gestures — Java API Reference (Appium 2.x+)

> Official Appium 2.x Java Client (`PointerInput`, `Sequence`) W3C Actions touch gestures and mobile execute scripts.
