...
description: 'Perform auto-waiting web interactions and keyboard/mouse actions in Vibium. Use when clicking, typing, hovering, or dragging elements with built-in stability, visibility, and editability actionability checks.'
user-invocable: true
license: MIT
